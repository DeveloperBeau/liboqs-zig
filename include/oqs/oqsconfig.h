...
// Maximal portable-only build configuration for ZigOQS:
// every KEM/SIG family + portable variant enabled; UOV (needs OpenSSL),
// stateful signatures, and all optimized backends are excluded.
...
// UOV (requires OpenSSL), stateful signatures (XMSS/LMS), and all
// optimized backends are intentionally left undefined.
